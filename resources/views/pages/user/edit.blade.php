                                    ...
                                    <div class="barang" id="barang1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Alamat</label>
                                                    <input required  type="text" name="alamat" class="form-control username-barang" value="{{ $data->alamat }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select required name="role" id="" class="form-control">
                                                        ...
                                                        <option {{ $data->role == 'penjual' ? 'selected' : '' }} value="penjual">Penjual</option>
