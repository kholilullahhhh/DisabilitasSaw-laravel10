<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ $menu == 'guru' ? 'active' : ''}}"><a class="nav-link" href="{{ route('guru.index') }}"><i
                        class="fas fa-print"></i><span>Data Guru</span></a></li>
            ...
            <li class="{{ $menu == 'obser' ? 'active' : ''}}"><a class="nav-link" href="{{ route('obser.index') }}"><i
                        class="fas fa-print"></i><span>Observasi</span></a></li>
